...
### Chart B: tmax trends in 2010 by month
...
noaa_new %>% 
  ...
  rename(precipitation = prcp, number_of_days = n) %>% 
  plot_ly(x = ~precipitation, y = ~number_of_days, color = ~precipitation, type = "bar", colors = "viridis")
